...
## Bonus: Reportes en Word

Muchas organizaciones, particularmente dependencias de gobieron, requieren ciertos machotes para la entrega/presentación de documentos. Quarto tambien nos da opciones para esto. Como por ejemplo, el logo que notan en la esquina superior derecha de esta página.

Esto se genera mediante este código:
```{r}
...
Aunque en estos momentos utilizamos documentos html, podemos generar **documentos en word**.
